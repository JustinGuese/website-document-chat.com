    ...
    <div class="row align-items-center justify-content-around">
      ...
      <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-in">
        <div class="content">
          ...
          <p>在本演示视频中，您将学习如何将 Outlook 邮件导入 document-chat.com 并向聊天机器人询问相关问题。</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row align-items-center">
      <div class="col-lg-4 col-md-5" data-aos="fade-in">
        <div class="content">
          ...
          <p>您还可以轻松地导入 Word、PowerPoint 和 PDF 文档，并与聊天机器人讨论它们。</p>
        </div>
      </div>
    ...
    <div class="row align-items-center justify-content-around">
      ...
      <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-in">
        <div class="content">
          ...
          <p>本演示视频展示了如何利用企业知识丰富聊天机器人，使其能够执行诸如营销等任务，不同于 ChatGPT 等。</p>
        </div>
      </div>
    </div>
  </div>
