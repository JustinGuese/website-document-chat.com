...
about_us:
  ...
  content: 'DataFortress.cloud est une entreprise basée à Augsbourg, en Allemagne,
...
achivement:
  content: Combien de temps passez-vous à chercher des anciens emails et des notes
...
banner:
  button:
    content: 'Aucun carte de crédit requis. Fonctionne dans tous les navigateurs.

      '
    enable: true
    label: Essayer gratuitement
    link: Tarification
  content: 'ChatGPT et consorts sont trop généraux ? **Docu-chat.de** connaît vos
  ...
  form_freebie:
    ...
    enable: true
    form_action: https://formspree.io/f/xbjnpgko
    pdf_explanation: 'Dans ce PDF gratuit, vous apprendrez à utiliser ChatGPT avec
...
clients_logo_slider:
  ...
  - 'images/marques/06-colorées.png
    ...
    '
homepage_howtouse:
  content: 'Docu-chat.de peut être utilisé dans de nombreux domaines. Voici quelques
    exemples de comment utiliser Docu-chat.de pour vous et dans votre entreprise.
  ...
  - button:
      ...
      link: Fonctionnement
    content: 'Contrairement à Outlook et consorts, vous n''avez pas besoin de trouver
  ...
  - button:
      ...
      label: En savoir plus
      link: Fonctionnement
    content: 'Vos documents sont désordonnés et ne portent que le nom "final_final_final.docx"
  ...
  - button:
      ...
      label: En savoir plus
      link: Fonctionnement
    content: 'ChatGPT et consorts n''en savent rien de votre entreprise. Les commandes
  ...
  - button:
      ...
      label: En savoir plus
      link: Fonctionnement
    content: 'Savez-vous cette situation où vous vous laissez trop emporter par un
...
homepage_tab:
  content: 'Téléchargez vos documents et e-mails, et posez des questions à notre IA.  Elle
  ...
  - button:
      ...
      label: En savoir plus
      link: Fonctionnement
    content: 'Téléversez des documents (Word, PowerPoint, TXT, PDF, etc.), des emails
  ...
  - button:
      ...
      label: En savoir plus
      link: Fonctionnement
    content: Après le téléchargement, vous pouvez poser à l'IA toutes les questions
  ...
  - button:
    ...
    content: 'ChatGPT et consorts ne permettent pas vraiment la séparation des connaissances
  ...
  - button:
      ...
      label: En savoir plus
      link: Fonctionnement
    content: 'Construisez la base de données ultime des connaissances de votre entreprise.
...
testimonial:
  ...
  enable: true
  testimonial_item:
  - content: 'J''utilise Docu-chat.de pour rechercher mes emails. La recherche Outlook
      ne fonctionnait jamais vraiment pour moi, mais Docu-chat.de trouve toujours
    ...
    name: Max Linnemann
  - content: 'Nous utilisons Docu-chat.de comme base de connaissances interne. Nos
      ...
      Docu-chat.de est intégré à notre intranet et peut répondre aux questions des
